...
while True:
    ...
    if rocket_b.ycor() - 50 <= ball.ycor() <= rocket_b.ycor() + 50 and \
            rocket_b.xcor() - 5 <= ball.xcor() <= rocket_b.xcor() + 5:
        ball.dx = -ball.dx

    if rocket_a.ycor() - 50 <= ball.ycor() <= rocket_a.ycor() + 50 and \
            rocket_a.xcor() - 5 <= ball.xcor() <= rocket_a.xcor() + 5:
        ball.dx = -ball.dx
